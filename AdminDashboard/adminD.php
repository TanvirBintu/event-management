    ...
    if (isset($_POST['action']) && isset($_POST['event_id'])) {
        ...
        if ($action === 'confirm') {
            ...
            if ($result->num_rows > 0) {
                ...
                $sqlInsert = "INSERT INTO booked_event (Event_Name, Start_Date, End_Date, Organizer, Vanue, Event_des, Event_img) 
                              VALUES ('$event_name', '$start_date', '$end_date', '$organizer', '$venue', '$event_des', '$event_img')";
            ...
            if ($result->num_rows > 0) {
                ...
                $sqlInsert = "INSERT INTO rejected_event (Event_Name, Start_Date, End_Date, Organizer, Vanue, Event_des, Event_img) 
                              VALUES ('$event_name', '$start_date', '$end_date', '$organizer', '$venue', '$event_des', '$event_img')";
