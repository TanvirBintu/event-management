...
if (isset($_POST['submit'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["Event_img"]["tmp_name"], $targetFile)) {
            ...
            $createQuery = "INSERT INTO `creat_event` (Your_Name, Your_ID, Event_Name, Start_Date, Organizer, End_Date, Vanue, Event_des, Event_img) 
                            VALUES ('$Your_Name', '$Your_ID', '$Event_Name', '$Start_Date', '$Organizer', '$End_Date', '$Vanue', '$Event_des', '$targetFile')";
            $result_create_query = mysqli_query($conn, $createQuery);

            $pendingQuery = "INSERT INTO `pending_event` (Your_Name, Your_ID, Event_Name, Start_Date, Organizer, End_Date, Vanue, Event_des, Event_img) 
                             VALUES ('$Your_Name', '$Your_ID', '$Event_Name', '$Start_Date', '$Organizer', '$End_Date', '$Vanue', '$Event_des', '$targetFile')";
